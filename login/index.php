...
<body class="bg-white-50 w-screen flex flex-col h-screen">
    ...
    <div class="container mx-auto flex-1 flex items-center justify-center text-center">
        <div class="w-2/4">
            ...
            <h1 class="font-bold text-2xl"> Welcome <span class="text-purple-600">Back</span> .</h1>
            <p class="text-gray-400">Logn back into your account and start sharing.</p>
            <form method="post" action="./../controllers/Auth.php" name="login_form" class="w-full flex-1 space-y-3 mt-5">
                <div class="w-full text-left">
                    <label for="" class="text-sm font-bold text-gray-500">Email</label>
                    <input type="text" class="w-full border p-3 rounded" name="email" placeholder="Email address" />
                </div>
                <div class="w-full text-left">
                    <label for="" class="text-sm font-bold text-gray-500">Password</label>
                    <input type="password" class="w-full border p-3 rounded" name="password" placeholder="Password" />
                </div>
                <button name="login_form" type="submit" class=" bg-purple-600 w-full p-3 text-white font-semibold rounded" >Sign in</button>
            </form>
        </div>
