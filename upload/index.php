    ...
    <div class="bg-gray-500 h-screen w-screen sm:px-8 md:px-16 sm:py-8">
        <main class="container mx-auto max-w-screen-lg h-full">
          ...
          <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
            ...
            <form action="./../controllers/Upload.php" method="POST" id="file_form" enctype="multipart/form-data" class="h-full overflow-auto p-8 w-full h-full flex flex-col">
              <header class="border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center">
                <p class="mb-3 font-semibold text-gray-900 flex flex-wrap justify-center">
                  <span>Drag and drop your</span>&nbsp;<span>files anywhere or</span>
                </p>
                <input id="hidden-input" type="file" multiple="false" class="hidden" id="input_file" name="file_data" />
              ...
              <div class="mt-3">
                  <p>Please chose a privacy option.</p>
                <div>
                <div class="space-x-5">
            ...
            <footer class="flex justify-end px-8 pb-8 pt-4">
              ...
              <a href="./../storage/" id="cancel" class="ml-3 rounded-sm px-3 py-1 hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                Cancel
              </a>
            </footer>
